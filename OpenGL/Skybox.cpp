...
Skybox::Skybox(std::vector<std::string> faceLocations){
    ...
    glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MIN_FILTER, GL_LINEAR);   // zoom out
    glTexParameteri(GL_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, GL_LINEAR);   // zoom in
...
void Skybox::draw(glm::mat4 viewMatrix, glm::mat4 projectionMatrix){
    ...
    skyShader->validate(skyMesh->VAO);
